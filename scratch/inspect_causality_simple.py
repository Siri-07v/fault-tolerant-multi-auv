...
def mock_run_auction_round(self, amvs, tasks, comms, current_timestep):
    print(f"MOCK RUN AUCTION ROUND CALLED AT t={current_timestep}")
...
# Let's also patch main.MieleConsensus just in case!
main.MieleConsensus.run_auction_round = mock_run_auction_round
